...
class Yolov5Runnable(vtsserving.Runnable):
...
yolo_v5_runner = vtsserving.Runner(Yolov5Runnable, max_batch_size=30)

svc = vtsserving.Service("yolo_v5_demo", runners=[yolo_v5_runner])
