...
class GenerateLatestMiddleware:
    def __init__(self, app: ext.ASGIApp):
        ...
        self.app = app
        self.metrics_client = VtsServingContainer.metrics_client.get()
...
def main(fd: int, backlog: int, prometheus_dir: str | None):
    ...
    \b
    This is an internal API, users should not use this directly. Instead use 'vtsserving serve-grpc'.
