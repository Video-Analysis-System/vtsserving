...
from vtsserving._internal.server.grpc.servicer import create_vts_servicer
...
def make_pb_ndarray(arr: NDArray[t.Any]) -> pb.NDArray:
    from vtsserving._internal.io_descriptors.numpy import npdtype_to_dtypepb_map
    from vtsserving._internal.io_descriptors.numpy import npdtype_to_fieldpb_map
