...
from vtsserving.exceptions import YataiRESTApiClientError
...
@inject
def get_config_path(vtsserving_home: str = Provide[VtsServingContainer.vtsserving_home]) -> Path:
    return Path(vtsserving_home) / ".yatai.yaml"
