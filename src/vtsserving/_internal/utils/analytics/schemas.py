...
# Refer to vtsserving/yatai-deployment-operator/common/consts/consts.go
...
def get_client_info(
    ...
    if os.path.exists(CLIENT_INFO_FILE_PATH):
        ...
        # write client info to ~/vtsserving/client_id
...
class CommonProperties:
    ...
    vtsserving_version: str = attr.field(default=VTSSERVING_VERSION)
...
class ServeInitEvent(EventMeta):
    ...
    vts_creation_timestamp: t.Optional[datetime]
