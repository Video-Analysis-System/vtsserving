...
vtsserving_cattr = Converter(omit_if_default=True)
...
vtsserving_cattr.register_structure_hook_factory(
    attr.has,
...
vtsserving_cattr.register_unstructure_hook_factory(
    attr.has,
...
vtsserving_cattr.register_structure_hook(datetime, datetime_structure_hook)
vtsserving_cattr.register_unstructure_hook(datetime, lambda dt: dt.isoformat())
