...
class Multipart(IODescriptor[t.Dict[str, t.Any]], descriptor_id="vtsserving.io.Multipart"):
    """
    ...
    Args:
        inputs: Dictionary consisting keys as inputs definition for a Multipart
                request/response, values as IODescriptor supported by VtsServing. Currently,
    ...
    async def from_proto(self, field: pb.Multipart) -> dict[str, t.Any]:
        from vtsserving.grpc.utils import validate_proto_fields
