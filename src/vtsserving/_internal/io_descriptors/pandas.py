...
EXC_MSG = "pandas' is required to use PandasDataFrame or PandasSeries. Install with 'pip install vtsserving[io-pandas]'"
...
class PandasDataFrame(
    IODescriptor["ext.PdDataFrame"], descriptor_id="vtsserving.io.PandasDataFrame"
):
    """
...
class PandasSeries(
    IODescriptor["ext.PdSeries"], descriptor_id="vtsserving.io.PandasSeries"
):
    """
