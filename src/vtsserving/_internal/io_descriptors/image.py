...
PIL_EXC_MSG = "'Pillow' is required to use the Image IO descriptor. Install with 'pip install vtsserving[io-image]'."
...
class Image(IODescriptor[ImageType], descriptor_id="vtsserving.io.Image"):
    """
    ...
    .. code-block:: python
       ...
       runner = vtsserving.tensorflow.get('image-classification:latest').to_runner()

       svc = vtsserving.Service("vit-object-detection", runners=[runner])
    ...
    def _from_sample(self, sample: ImageType | str) -> ImageType:
        try:
            ...
            raise MissingDependencyException(
                "'filetype' is required to use 'from_sample'. Install it with 'pip install vtsserving[io-image]'."
            )
