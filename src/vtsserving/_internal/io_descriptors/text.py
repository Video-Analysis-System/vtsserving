...
class Text(IODescriptor[str], descriptor_id="vtsserving.io.Text"):
    """
    ...
    .. code-block:: python
       ...
       runner = vtsserving.tensorflow.get('gpt2:latest').to_runner()

       svc = vtsserving.Service("gpt2-generation", runners=[runner])
