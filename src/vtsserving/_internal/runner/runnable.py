...
RUNNABLE_METHOD_MARK: str = "_vtsserving_runnable_method"
...
class Runnable:
    ...
    vtsserving_runnable_methods__: dict[
...
class RunnableMethod(t.Generic[T, P, R]):
    ...
    _vtsserving_runnable_method: None = None
    ...
    def __set_name__(self, owner: t.Any, name: str):
        if owner.vtsserving_runnable_methods__ is None:
            owner.vtsserving_runnable_methods__ = {}
        owner.vtsserving_runnable_methods__[name] = self
