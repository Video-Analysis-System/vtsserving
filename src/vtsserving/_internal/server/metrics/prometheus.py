...
class PrometheusClient:
    def __init__(
        ...
        *,
        ...
        """
        PrometheusClient is VtsServing's own prometheus client that extends the official Python client.

        It sets up a multiprocess dir for Prometheus to work in multiprocess mode, which is required
        for VtsServing to work in production.
        ...
        For API documentation, refer to https://docs.vtsserving.org/en/latest/reference/metrics.html.
        """
        if multiproc:
    ...
    def Metric(self):
        ...
        This is a base class to be used by instrumentation client. Custom collectors should use ``vtsserving.metrics.metrics_core.GaugeMetricFamily``, ``vtsserving.metrics.metrics_core.CounterMetricFamily``, ``vtsserving.metrics.metrics_core.SummaryMetricFamily`` instead.
        """
