...
from vtsserving.exceptions import InternalServerError
...
APP_TAG = Tag(
    name="Service APIs", description="VtsServing Service API endpoints for inference."
)
...
def generate_spec(svc: Service, *, openapi_version: str = "3.0.2"):
    ...
    return OpenAPISpecification(
        ...
        info=Info(
            ...
            contact=Contact(name="VtsServing Team", email="contact@vtsserving.com"),
        ),
        paths={
