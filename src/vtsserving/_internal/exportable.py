        ...
        *,
        ...
        if isOSPath:
            ...
            if isCompressedPath:
                ...
                tempfs = fs.tempfs.TempFS(identifier=f"vtsserving-{filename}-import")
    ...
    def export(
        ...
        *,
        ...
        if fullpath == "" or (not output_format == "folder" and fullpath[-1] == "/"):
            ...
            # if the path has no filename or is empty, we generate a filename from the vts tag
        ...
        if isOSPath:
            ...
            if isCompressedPath:
                ...
                tempfs = fs.tempfs.TempFS(
                    identifier=f"vtsserving-{self._export_name}-export"
                )
                filename = fs.path.basename(subpath)
