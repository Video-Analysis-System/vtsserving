...
loggers:
  vtsserving_monitor_data:
    level: INFO
    handlers: [vtsserving_monitor_data]
    propagate: false
  vtsserving_monitor_schema:
    level: INFO
    handlers: [vtsserving_monitor_schema]
    propagate: false
handlers:
  vtsserving_monitor_data:
    class: logging.handlers.TimedRotatingFileHandler
    level: INFO
    formatter: vtsserving_json
...
class DefaultMonitor(MonitorBase["JSONSerializable"]):
    ...
    def _init_logger(self) -> None:
        ...
        self.data_logger = logging.getLogger("vtsserving_monitor_data")
        self.schema_logger = logging.getLogger("vtsserving_monitor_schema")
    ...
    def export_schema(self, columns_schema: dict[str, dict[str, str]]) -> None:
        ...
        self.schema_logger.info(
            dict(
                meta_data={
                    "vts_name": component_context.vts_name,
                    "vts_version": component_context.vts_version,
                },
