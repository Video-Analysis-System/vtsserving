...
# Sync with VtsServing extra dependencies found in pyproject.toml
FEATURES = frozenset(
    {
        "tracing",
        "grpc",
    ...
    *,
    ...
    with fs.open_fs("temp://") as temp_fs, open(
        ...
        if features is not None:
            ...
            instruction.append(
                "RUN %spip install vtsserving[%s]" % (PIP_CACHE_MOUNT, ",".join(features))
            )
...
def register_backend(
    ...
    *,
    ...
    .. code-block:: python
        ...
        from vtsserving.container import register_backend
