...
try:
    ...
    raise MissingDependencyException(
        "'pytorch_lightning' is required in order to use module 'vtsserving.pytorch_lightning', install python-lightning with: 'pip install pytorch-lightning'"
    )

MODULE_NAME = "vtsserving.pytorch_lightning"
...
def load_model(
    ...
    Args:
        ...
        model_store (:mod:`~vtsserving._internal.models.store.ModelStore`, default to :mod:`VtsServingContainer.model_store`):
            VtsServing modelstore, provided by DI Container.

    Returns:
        :obj:`torch.ScriptModule`: an instance of :obj:`torch.ScriptModule` from VtsServing modelstore.
    ...
    .. code-block:: python
        ...
        import vtsserving
        lit = vtsserving.torchscript.load_model('lit_classifier:latest', device_id="cuda:0")
    """
...
def save_model(
    ...
    *,
    ...
    .. code-block:: python
        ...
        tag = vtsserving.pytorch_lightning.save("lit_classifier", LitClassifier())
    """
