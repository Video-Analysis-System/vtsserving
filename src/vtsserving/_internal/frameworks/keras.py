...
try:
    ...
    raise MissingDependencyException(
        "Tensorflow is required in order to use module 'vtsserving.keras', since VtsServing uses Tensorflow as Keras backend. Install Tensorflow with 'pip install tensorflow'. For more information, refer to https://www.tensorflow.org/install"
    )

MODULE_NAME = "vtsserving.keras"
API_VERSION = "v1"
...
def get(tag_like: str | Tag) -> vtsserving.Model:
    ...
    .. code-block:: python
       ...
       model = vtsserving.keras.get("keras_resnet50")
    """
...
def load_model(
    ...
    """
    Load a model from VtsServing local modelstore with given name.
    ...
    Returns:
        :obj:`keras.Model`: an instance of users :obj:`keras.Model` from VtsServing modelstore.
    ...
    .. code-block:: python
        ...
        loaded = vtsserving.keras.load_model("keras_model")
    ...
    with tf.device(device_name):
        return keras.models.load_model(
            vts_model.path,
            custom_objects=vts_model.custom_objects,
        )
    ...
    *,
    ...
    Args:
        ...
        model (:obj:`tensorflow.keras.Model` | :obj:`tensorflow.keras.engine.sequential.Sequential`):
            Instance of the Keras model to be saved to VtsServing modelstore.
    ...
    .. code-block:: python
        ...
        vts_model = vtsserving.keras.save_model("keras_model", model)
        ...
        custom_vts_model = vtsserving.keras.save_model("custom_obj_keras", custom_objects=custom_objects)
...
def get_runnable(
    ...
    partial_kwargs: t.Dict[str, t.Any] = vts_model.info.options.partial_kwargs  # type: ignore
