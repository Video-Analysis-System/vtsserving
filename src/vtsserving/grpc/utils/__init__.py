...
from vtsserving.grpc.utils._import_hook import import_grpc
from vtsserving.grpc.utils._import_hook import import_generated_stubs
...
def grpc_status_code(err: VtsServingException) -> grpc.StatusCode:
    """
    Convert VtsServingException.error_code to grpc.StatusCode.
    """
