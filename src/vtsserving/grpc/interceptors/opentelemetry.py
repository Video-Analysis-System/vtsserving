...
from vtsserving.grpc.utils import GRPC_CONTENT_TYPE
from vtsserving.grpc.utils import parse_method_name
from vtsserving._internal.utils.pkg import get_pkg_version
...
class AsyncOpenTelemetryServerInterceptor(aio.ServerInterceptor):
    ...
    def __init__(
        self,
        *,
        tracer_provider: TracerProvider = Provide[VtsServingContainer.tracer_provider],
