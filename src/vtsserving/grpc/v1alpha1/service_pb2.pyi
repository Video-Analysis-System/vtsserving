...
class Request(google.protobuf.message.Message):
    ...
    api_name is the name of the function defined in vtsserving.Service.
    Example:
    ...
    """serialized_bytes is for data serialized in VtsServing's internal serialization format."""
    def __init__(
        self,
        *,
        api_name: builtins.str = ...,
...
class File(google.protobuf.message.Message):
    ...
    class FileType(_FileType, metaclass=_FileTypeEnumTypeWrapper):
        """FileType represents possible file type to be handled by VtsServing.
